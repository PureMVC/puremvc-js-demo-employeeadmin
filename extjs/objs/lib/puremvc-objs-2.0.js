...
new function()
{
	...
	(
		"puremvc.View",
		{
			 ...
			 *
			 * @param {String} mediatorName
			 *		Name of the <code>IMediator</code> instance to verify the
...
new function()
{
	...
	/**
	 * @classDescription
	 * The Base <code>Notifier</code> implementation.
	 *
	 * <P>
...
new function()
{
	/**
	 * @classDescription 
	 * <P>A base <code>Command</code> implementation that executes other
	 * <code>Command</code>s.
	 *
	 * <P>
	 * A <code>MacroCommand</code> maintains an list of
	 * <code>ICommand</code> Class references called <i>SubCommands</i>.
	 *
	 * <P>
	 * When <code>execute</code> is called, the <code>MacroCommand</code>
	 * instantiates and calls <code>execute</code> on each of its
	 * <i>SubCommands</i> turn. Each <i>SubCommand</i> will be passed a reference
	 * to the original <code>INotification</code> that was passed to the
	 ...
	 * <code>initMacroCommand</code> method, calling <code>addSubCommand</code>
	 * once for each <i>SubCommand</i> to be executed.
	 * 
	 * @extends puremvc.Notifier Notifier
	 * 
	 * @constructor
