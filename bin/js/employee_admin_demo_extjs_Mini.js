Ext.ns("Puremvc.demo");Puremvc.demo.ApplicationFacade=Ext.extend(puremvc.Facade,{constructor:function(key){Puremvc.demo.ApplicationFacade.superclass.constructor.call(this,key);
...
}};Ext.ns("Puremvc.demo.controller");Puremvc.demo.controller.AddRoleResultCommand=Ext.extend(puremvc.AsyncCommand,{execute:function(notification){var result=notification.getBody();
if(result===false){Puremvc.demo.common.Util.alert("Role already exists for this user!","Add User Role");
}this.commandComplete();}});Ext.ns("Puremvc.demo.controller");Puremvc.demo.controller.DeleteUserCommand=Ext.extend(puremvc.AsyncCommand,{execute:function(notification){var user=notification.getBody();
...
}});Ext.namespace("Puremvc.demo.controller");Puremvc.demo.controller.PrepControllerCommand=Ext.extend(puremvc.AsyncCommand,{constructor:function(){Puremvc.demo.controller.PrepControllerCommand.superclass.constructor.call(this);
...
this.commandComplete();}});Ext.ns("Puremvc.demo.controller");Puremvc.demo.controller.PrepModelCommand=Ext.extend(puremvc.AsyncCommand,{execute:function(notification){this.facade.registerProxy(new Puremvc.demo.model.UserProxy());
this.facade.registerProxy(new Puremvc.demo.model.RoleProxy());this.commandComplete();
}});Ext.ns("Puremvc.demo.controller");Puremvc.demo.controller.PrepViewCommand=Ext.extend(puremvc.AsyncCommand,{execute:function(notification){var app=new Puremvc.demo.view.components.Application({});
this.facade.registerMediator(new Puremvc.demo.view.ApplicationMediator(app));this.commandComplete();
}});Ext.ns("Puremvc.demo.controller");Puremvc.demo.controller.StartupCommand=Ext.extend(puremvc.AsyncMacroCommand,{initializeAsyncMacroCommand:function(note){this.addSubCommand(Puremvc.demo.controller.PrepControllerCommand);
...
return cList;}});Ext.ns("Puremvc.demo.model");Puremvc.demo.model.RoleProxy=Ext.extend(puremvc.Proxy,{constructor:function(){Puremvc.demo.model.RoleProxy.superclass.constructor.call(this,Puremvc.demo.model.RoleProxy.NAME,[]);
...
Ext.ns("Puremvc.demo.model");Puremvc.demo.model.UserProxy=Ext.extend(puremvc.Proxy,{constructor:function(){Puremvc.demo.model.UserProxy.superclass.constructor.call(this,Puremvc.demo.model.UserProxy.NAME,[]);
...
Ext.ns("Puremvc.demo.view");Puremvc.demo.view.RolePanelMediator=Ext.extend(puremvc.Mediator,{constructor:function(viewComponent){Puremvc.demo.view.RolePanelMediator.superclass.constructor.call(this,Puremvc.demo.view.RolePanelMediator.NAME,viewComponent);
...
Ext.ns("Puremvc.demo.view");Puremvc.demo.view.UserFormMediator=Ext.extend(puremvc.Mediator,{constructor:function(viewComponent){Puremvc.demo.view.UserFormMediator.superclass.constructor.call(this,Puremvc.demo.view.UserFormMediator.NAME,viewComponent);
