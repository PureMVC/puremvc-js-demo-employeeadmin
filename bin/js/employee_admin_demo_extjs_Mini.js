...
}}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.AddRoleResultCommand",{extend:"puremvc.AsyncCommand",execute:function(notification){var result=notification.getBody();
if(result===false){Puremvc.demo.common.Util.alert("Role already exists for this user!","Add User Role");
}this.commandComplete();}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.DeleteUserCommand",{extend:"puremvc.AsyncCommand",execute:function(notification){var user=notification.getBody();
...
}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.PrepControllerCommand",{extend:"puremvc.AsyncCommand",constructor:function(){this.callParent(arguments);
...
this.commandComplete();}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.PrepModelCommand",{extend:"puremvc.AsyncCommand",constructor:function(){this.callParent(arguments);
...
}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.PrepViewCommand",{extend:"puremvc.AsyncCommand",constructor:function(){this.callParent(arguments);
...
}});Ext.namespace("Puremvc.demo.controller");Ext.define("Puremvc.demo.controller.StartupCommand",{extend:"puremvc.AsyncMacroCommand",initializeAsyncMacroCommand:function(note){this.addSubCommand(Puremvc.demo.controller.PrepControllerCommand);
