...
this.context=context;}});UiComponent.QUEUE_PATTERN="@_@";UiComponent.equals=function(compared){if(compared.listener==this.listener){if(typeof compared.context!="undefined"){if(compared.context==null&&this.context==null){return true;
...
},onSelect:function(selectedUserName){var uname=this.getUserList().getSelectedUser();
var userProxy=this.facade.retrieveProxy(ProxyNames.USER_PROXY);var selectedUser=userProxy.getUser(uname);
this.sendNotification(NotificationNames.USER_SELECTED,selectedUser);}});var ApplicationFacade=Objs("org.puremvc.js.demos.objs.employeeadmin.ApplicationFacade",Facade,{startup:function(app){this.sendNotification(NotificationNames.STARTUP,app);
